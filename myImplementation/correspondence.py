class Correspondence:
    ...
    def __init__(self):
        self.point_s = None
        self.point_s_coordinates = ()
        self.s_i = 0
        self.point_t = None
        self.point_t_coordinates = ()
        self.t_i = 0
        self.cost = 0

    def __str__(self):
        return f"[{self.s_i}]({self.point_s_coordinates}:{self.point_s}) -> [{self.t_i}]({self.point_t_coordinates}:{self.point_t});"